...
#include "MoskitoSoluteTimeKernel.h"

registerMooseObject("MoskitoApp", MoskitoSoluteTimeKernel);

InputParameters
MoskitoSoluteTimeKernel::validParams()
{
...
MoskitoSoluteTimeKernel::MoskitoSoluteTimeKernel(const InputParameters & parameters)
...
Real
MoskitoSoluteTimeKernel::computeQpResidual()
{
...
Real
MoskitoSoluteTimeKernel::computeQpJacobian()
{
  Real test = 0.0, j = 0.0;
