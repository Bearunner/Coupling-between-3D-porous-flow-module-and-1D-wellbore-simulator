...
#include "MoskitoSolutePointSourceS.h"
#include "FEProblemBase.h"

registerMooseObject("MoskitoApp", MoskitoSolutePointSourceS);


InputParameters
MoskitoSolutePointSourceS::validParams()
{
...
MoskitoSolutePointSourceS::MoskitoSolutePointSourceS(
    ...
    // _rhof(getMaterialProperty<Real>("fluid_density"))
{
  ...
  if (_end_time <= _start_time)
    mooseError("Start time for MoskitoSolutePointSourceS is ",_start_time,
                " but it must be less than end time ",_end_time);
}

void
MoskitoSolutePointSourceS::addPoints()
{
  addPoint(_p);
}

Real
MoskitoSolutePointSourceS::computeQpResidual()
{
