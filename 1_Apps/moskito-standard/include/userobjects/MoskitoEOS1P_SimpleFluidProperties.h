...
// class MoskitoEOS1P_SimpleFluidProperties;
//
// template <>
// InputParameters validParams<MoskitoEOS1P_SimpleFluidProperties>();

class MoskitoEOS1P_SimpleFluidProperties : public MoskitoEOS1P
{
public:
  static InputParameters validParams();
  MoskitoEOS1P_SimpleFluidProperties(const InputParameters & parameters);
