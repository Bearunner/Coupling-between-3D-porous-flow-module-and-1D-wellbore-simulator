...
class MoskitoDictator : public GeneralUserObject, public Coupleable
{
public:
  static InputParameters validParams();

  MoskitoDictator(const InputParameters & parameters);
   ...
   */
  unsigned int MoskitoVariableNum(unsigned int moose_var_num) const;
   ...
   */
  bool isMoskitoVariable(unsigned int moose_var_num) const;
   ...
   */
  bool notMoskitoVariable(unsigned int moose_var_num) const;
