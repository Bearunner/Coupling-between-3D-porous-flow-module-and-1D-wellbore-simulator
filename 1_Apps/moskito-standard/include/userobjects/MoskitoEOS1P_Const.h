...
// class MoskitoEOS1P_Const;
//
// template <>
// InputParameters validParams<MoskitoEOS1P_Const>();

class MoskitoEOS1P_Const : public MoskitoEOS1P
{
public:
  // MoskitoEOS1P_Const(const InputParameters & parameters);
  static InputParameters validParams();
  MoskitoEOS1P_Const(const InputParameters & parameters);
  // virtual ~MoskitoEOS1P_Const();
