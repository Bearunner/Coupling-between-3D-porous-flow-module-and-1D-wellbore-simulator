...
#ifndef MOSKITOENERGYPOINTSOURCET_H
#define MOSKITOENERGYPOINTSOURCET_H
 ...
 */
class MoskitoEnergyPointSourceT : public DiracKernel
{
public:
  static InputParameters validParams();
  MoskitoEnergyPointSourceT(const InputParameters & parameters);
...
protected:
  ...
  const Function * _energy_flux_function;
...
#endif // MOSKITOENERGYPOINTSOURCET_H
