...
#ifndef MOSKITOSOLUTEPOINTSOURCES_H
#define MOSKITOSOLUTEPOINTSOURCES_H
 ...
 */
class MoskitoSolutePointSourceS : public DiracKernel
{
public:
  static InputParameters validParams();
  MoskitoSolutePointSourceS(const InputParameters & parameters);
...
#endif // MOSKITOSOLUTEPOINTSOURCES_H
