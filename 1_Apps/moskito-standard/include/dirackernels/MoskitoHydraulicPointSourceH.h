...
#ifndef MOSKITOHYDRAULICPOINTSOURCEH_H
#define MOSKITOHYDRAULICPOINTSOURCEH_H
 ...
 */
class MoskitoHydraulicPointSourceH : public DiracKernel
{
public:
  static InputParameters validParams();
  MoskitoHydraulicPointSourceH(const InputParameters & parameters);
...
#endif // MOSKITOHYDRAULICPOINTSOURCEH_H
