...
#ifndef MOSKITOSOLUTESOURCEKERNELS2_H
#define MOSKITOSOLUTESOURCEKERNELS2_H
...
class MoskitoSoluteSourceKernelS2 : public Kernel
{
public:
  static InputParameters validParams();
  MoskitoSoluteSourceKernelS2(const InputParameters & parameters);

protected:
  virtual Real computeQpResidual() override;

  const VariableValue & _C1;
  const MaterialProperty<Real> & _new_C1;
...
#endif  //MOSKITOSOLUTESOURCEKERNELS2_H
