...
#ifndef MOSKITOSOLUTEADVECTIONKERNELS_H
#define MOSKITOSOLUTEADVECTIONKERNELS_H

#include "Kernel.h"
#include "RankTwoTensor.h"


class MoskitoSoluteAdvectionKernelS : public Kernel
{
public:
  static InputParameters validParams();
  MoskitoSoluteAdvectionKernelS(const InputParameters & parameters);
...
#endif // MOSKITOSOLUTEADVECTIONKERNELS_H
