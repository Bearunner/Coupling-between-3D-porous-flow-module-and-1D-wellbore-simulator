...
#ifndef MOSKITOSOLUTETIMEKERNELS_H
#define MOSKITOSOLUTETIMEKERNELS_H

#include "TimeDerivative.h"



class MoskitoSoluteTimeKernelS : public TimeDerivative
{
public:
  static InputParameters validParams();
  MoskitoSoluteTimeKernelS(const InputParameters & parameters);
...
#endif // MOSKITOSOLUTETIMEKERNELS_H
