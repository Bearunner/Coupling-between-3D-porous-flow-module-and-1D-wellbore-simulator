 ...
 * viscosity
 */
class SimpleFluidProperties_new : public SinglePhaseFluidProperties
{
public:
  static InputParameters validParams();

  SimpleFluidProperties_new(const InputParameters & parameters);
  virtual ~SimpleFluidProperties_new();
