...
#include "SimpleFluidProperties_new.h"
#include "NewtonInversion.h"

registerMooseObject("FluidPropertiesApp", SimpleFluidProperties_new);

InputParameters
SimpleFluidProperties_new::validParams()
{
...
SimpleFluidProperties_new::SimpleFluidProperties_new(const InputParameters & parameters)
...
SimpleFluidProperties_new::~SimpleFluidProperties_new() {}

std::string
SimpleFluidProperties_new::fluidName() const
{
  return "simple_fluid";
}

Real
SimpleFluidProperties_new::molarMass() const
{
  return _molar_mass;
}

Real SimpleFluidProperties_new::beta_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _thermal_expansion;
}

void
SimpleFluidProperties_new::beta_from_p_T(
...
Real SimpleFluidProperties_new::cp_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _cp;
}

void
SimpleFluidProperties_new::cp_from_p_T(
...
Real SimpleFluidProperties_new::cp_from_v_e(Real /*v*/, Real /*e*/) const { return _cp; }

void
SimpleFluidProperties_new::cp_from_v_e(Real v, Real e, Real & cp, Real & dcp_dv, Real & dcp_de) const
{
  cp = cp_from_v_e(v, e);
  dcp_dv = 0.0;
  dcp_de = 0.0;
...
Real SimpleFluidProperties_new::cv_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _cv;
}

void
SimpleFluidProperties_new::cv_from_p_T(
...
Real SimpleFluidProperties_new::cv_from_v_e(Real /*v*/, Real /*e*/) const { return _cv; }

void
SimpleFluidProperties_new::cv_from_v_e(Real v, Real e, Real & cv, Real & dcv_dv, Real & dcv_de) const
{
  cv = cv_from_v_e(v, e);
  dcv_dv = 0.0;
  dcv_de = 0.0;
...
Real
SimpleFluidProperties_new::c_from_p_T(Real pressure, Real temperature) const
{
  return std::sqrt(_bulk_modulus / rho_from_p_T(pressure, temperature));
}

void
SimpleFluidProperties_new::c_from_p_T(
...
Real
SimpleFluidProperties_new::c_from_v_e(Real v, Real e) const
{
...
void
SimpleFluidProperties_new::c_from_v_e(Real v, Real e, Real & c, Real & dc_dv, Real & dc_de) const
{
  Real T = T_from_v_e(v, e);
  Real p = p_from_v_e(v, e);
...
Real SimpleFluidProperties_new::k_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _thermal_conductivity;
}

void
SimpleFluidProperties_new::k_from_p_T(
...
Real SimpleFluidProperties_new::k_from_v_e(Real /*v*/, Real /*e*/) const
{
  return _thermal_conductivity;
}

void
SimpleFluidProperties_new::k_from_v_e(
...
Real SimpleFluidProperties_new::s_from_p_T(Real /*pressure*/, Real /*temperature*/) const
{
  return _specific_entropy;
}

void
SimpleFluidProperties_new::s_from_p_T(
...
Real SimpleFluidProperties_new::s_from_h_p(Real /*enthalpy*/, Real /*pressure*/) const
{
  return _specific_entropy;
}

Real SimpleFluidProperties_new::s_from_v_e(Real /*v*/, Real /*e*/) const { return _specific_entropy; }

void
SimpleFluidProperties_new::s_from_v_e(
...
Real
SimpleFluidProperties_new::rho_from_p_T(Real pressure, Real temperature) const
{
  return _density0 * std::exp(pressure / _bulk_modulus - _thermal_expansion * temperature);
}

void
SimpleFluidProperties_new::rho_from_p_T(
...
void
SimpleFluidProperties_new::rho_from_p_T(const DualReal & pressure,
...
Real
SimpleFluidProperties_new::T_from_v_e(Real /*v*/, Real e) const
{
...
Real
SimpleFluidProperties_new::T_from_v_h(Real v, Real h) const
{
...
void
SimpleFluidProperties_new::T_from_v_h(Real v, Real h, Real & T, Real & dT_dv, Real & dT_dh) const
{
  T = T_from_v_h(v, h);
  dT_dv =
...
void
SimpleFluidProperties_new::T_from_v_e(Real v, Real e, Real & T, Real & dT_dv, Real & dT_de) const
{
  T = T_from_v_e(v, e);
  dT_dv = 0.0;
  dT_de = 1.0 / _cv;
...
void
SimpleFluidProperties_new::T_from_v_e(
...
Real
SimpleFluidProperties_new::T_from_p_rho(Real p, Real rho) const
{
...
void
SimpleFluidProperties_new::T_from_p_rho(Real p, Real rho, Real & T, Real & dT_dp, Real & dT_drho) const
{
...
Real
SimpleFluidProperties_new::T_from_p_h(Real p, Real h) const
{
...
Real
SimpleFluidProperties_new::p_from_v_e(Real v, Real e) const
{
...
void
SimpleFluidProperties_new::p_from_v_e(Real v, Real e, Real & p, Real & dp_dv, Real & dp_de) const
{
  p = p_from_v_e(v, e);
...
void
SimpleFluidProperties_new::p_from_v_e(
...
Real
SimpleFluidProperties_new::p_from_v_h(Real v, Real h) const
{
...
void
SimpleFluidProperties_new::p_from_v_h(Real v, Real h, Real & p, Real & dp_dv, Real & dp_dh) const
{
  Real T, dT_dv, dT_dh;
...
Real
SimpleFluidProperties_new::e_from_p_T(Real /*pressure*/, Real temperature) const
{
  return _cv * temperature;
}

void
SimpleFluidProperties_new::e_from_p_T(
...
Real
SimpleFluidProperties_new::e_from_p_rho(Real p, Real rho) const
{
...
void
SimpleFluidProperties_new::e_from_p_rho(Real p, Real rho, Real & e, Real & de_dp, Real & de_drho) const
{
...
Real
SimpleFluidProperties_new::e_from_v_h(Real v, Real h) const
{
  Real T = T_from_v_h(v, h);
...
void
SimpleFluidProperties_new::e_from_v_h(Real v, Real h, Real & e, Real & de_dv, Real & de_dh) const
{
  Real T, dT_dv, dT_dh;
  Real p, dp_dv, dp_dh;
  T_from_v_h(v, h, T, dT_dv, dT_dh);
...
Real SimpleFluidProperties_new::mu_from_p_T(Real /*pressure*/, Real temperature) const
{
  return 2.4e-5 * std::pow(10.0, 248.37 / (temperature - 140));
}

void
SimpleFluidProperties_new::mu_from_p_T(
...
Real SimpleFluidProperties_new::mu_from_v_e(Real /*v*/, Real /*e*/) const { return _viscosity; }

void
SimpleFluidProperties_new::mu_from_v_e(Real v, Real e, Real & mu, Real & dmu_dv, Real & dmu_de) const
{
...
Real
SimpleFluidProperties_new::h_from_p_T(Real pressure, Real temperature) const
{
...
void
SimpleFluidProperties_new::h_from_p_T(
