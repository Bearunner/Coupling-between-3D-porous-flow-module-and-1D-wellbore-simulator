 ...
 */
class PorousFlowMassTimeDerivativeS : public TimeKernel
{
public:
  static InputParameters validParams();

  PorousFlowMassTimeDerivativeS(const InputParameters & parameters);
...
protected:
  ...
  // const MaterialProperty<std::vector<std::vector<Real>>> & _new_C1_old;
  // const MaterialProperty<Real> & _new_C1_old;
