 ...
 */
class PorousFlowMassTimeDerivativeS2 : public TimeKernel
{
public:
  static InputParameters validParams();

  PorousFlowMassTimeDerivativeS2(const InputParameters & parameters);
...
protected:
  ...
  // const MaterialProperty<std::vector<std::vector<Real>>> & _new_C2_old;
  // const MaterialProperty<Real> & _new_C2_old;
